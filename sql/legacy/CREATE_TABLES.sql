-- Run this SQL in your SQL Editor to create the required tables
...
BEGIN
    ...
    ORDER BY 
        CASE 
            WHEN psf.unit_number ~ '^[0-9]+\.[0-9]+$' THEN 
...
-- If you want to allow authenticated users to access these tables:
-- GRANT ALL ON parsed_student_feedback TO authenticated;
-- GRANT ALL ON feedback_parsing_status TO authenticated;
-- GRANT SELECT ON student_feedback_summary TO authenticated;